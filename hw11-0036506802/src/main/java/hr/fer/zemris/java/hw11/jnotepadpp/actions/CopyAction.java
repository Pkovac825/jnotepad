...
/**
 * Akcija koja je sposobna kopirati odabrani tekst.
 *
 * @author Petar Kovač
 *
 */
public class CopyAction extends LocalizableAction implements MultipleDocumentListener, CaretListener{
	...
	public CopyAction(MultipleDocumentModel model, Buffer buffer, ILocalizationProvider provider) {
		super("Copy", provider);
		this.model = model;
		this.buffer = buffer;
